...
* We drop the very last reported week of 2020 for CHE, FIN, LTU, NOR, ESP, ISR, SVK, and USA which have steep declines due to incomplete reporting.
...
deaths = deaths[-which(CountryCode %in% c("ESP","USA") & Year==2020 & Week %in% 24:25)]
deaths = deaths[-which(CountryCode == "NOR" & Year==2020 & Week == 26)]
deaths = deaths[-which(CountryCode %in% c("CHE","FIN") & Year==2020 & Week==25)]
```
